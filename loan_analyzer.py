...
print(f"total loans are {total_loans}")
# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan=sum(loan_costs)/len(loan_costs)
print(f"average loan amount is {average_loan}")
...
# YOUR CODE HERE!
def calculate_present_value(futue_value,remaining_months,annual_discount_rate):
    present_value=future_value / (1 + annual_discount_rate/12) ** remaining_months
...
present_value=calculate_present_value(
    ...
    new_loan["remaining_months"], 0.20
...
# YOUR CODE HERE!
header row =loan_value
 loan_value=(inexpensive_loans_list)
 print(f"values)
header = ["loan_price", "remaining_months", "repayment_interval", "future_value"]
